                    ...
                    for(i=0;i<Q_LBM;i++){
                        ...
                        if(0<nx && nx<step-1 && 0<ny && ny<step-1 && 0<nz && nz<step-1){
                            if (flagField[x+y*step+z*step*step]==MOVING_WALL){
                                ...
                                computeDensity(&collideField[Q_LBM*(nx+ny*step+nz*step*step)],&density);
                                /* Compute dot product */
                                ...
                                collideField[Q_LBM*(x+y*step+z*step*step)+i]=
                                        collideField[Q_LBM*(nx+ny*step+nz*step*step)+inv(i)]+
