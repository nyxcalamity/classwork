...
void computeVelocity(const double * const current_cell, const double * const density, double *velocity){
    int i;
    /* 
    ...
    velocity[0]/=*density; velocity[1]/=*density; velocity[2]/=*density;
}
